...
- **Run timestamp**: 20260613T083908Z
- **Git SHA**: `c8a33a2`
- **Total questions**: 8
...
|-------------|----------|:---:|:-------:|:----:|:--------:|:---------:|:---------:|:-------:|:--------:|:-----:|:--------:|
| `cognition_001` | cognition | ✓ | ✓ | ✗ | 0.50 | 0.50 | 0.50 | 0.50 | 0.50 | 0.50 | 14 |
| `productivity_001` | productivity | ✗ | ✗ | ✗ | 0.00 | 0.33 | 0.00 | 0.33 | 0.67 | 0.00 | 13 |
| `memory_001` | memory | ✓ | ✓ | ✗ | 0.67 | 0.67 | 0.67 | 0.67 | 0.67 | 0.33 | 9 |
| `memory_002` | memory | ✗ | ✗ | ✗ | 0.00 | 0.25 | 0.00 | 0.00 | 0.25 | 0.00 | 8 |
| `therapy_001` | mental_health | ✓ | ✓ | ✗ | 0.50 | 0.50 | 0.50 | 0.50 | 0.50 | 0.50 | 15 |
| `digital_wellbeing_001` | digital_wellbeing | ✓ | ✗ | ✗ | 0.40 | 0.60 | 0.20 | 0.60 | 0.60 | 0.40 | 15 |
| `mental_health_001` | mental_health | ✗ | ✗ | ✗ | 0.00 | 0.25 | 0.00 | 0.00 | 0.25 | 0.00 | 13 |
| `psychology_001` | psychology | ✓ | ✗ | ✗ | 0.33 | 0.33 | 0.17 | 0.33 | 0.33 | 0.17 | 13 |
...
**LLM-cited URLs**:
- [1] `https://cognitiontoday.com/metacognition-metamemory-meta-skills/`
- [2] `https://cognitiontoday.com/easy-explanations-definitions-glossary-psychology-neuroscience/`
- [3] `https://cognitiontoday.com/the-heart-mind-relationship-is-more-than-a-metaphor/`
- [4] `https://cognitiontoday.com/what-is-cognition-executive-functions-and-cognitive-processes/` ✓
- [5] `https://cognitiontoday.com/chewing-gum-affects-mood-cognition-in-surprising-ways/`
- [6] `https://cognitiontoday.com/study-tips-for-psychology-students/`
- [7] `https://cognitiontoday.com/psychology-definition-nature-and-scope-types/`
- [8] `https://cognitiontoday.com/boost-memory-delay-cognitive-decline-memory-loss/`
...
- [1] `https://cognitiontoday.com/you-procrastinate-because-of-emotions-not-laziness-regulate-them-to-stop-procrastinating/`
- [2] `https://cognitiontoday.com/productivity-tips-for-early-career-employees/`
- [3] `https://cognitiontoday.com/how-to-increase-productivity-the-ultimate-psychological-guide/`
...
**LLM-cited URLs**:
- [1] `https://cognitiontoday.com/prospective-memory-explanation-and-how-to-build-it/`
- [2] `https://cognitiontoday.com/daily-memory-habits-to-improve-confidence-in-memory/`
- [3] `https://cognitiontoday.com/brain-benefits-from-exercise-mechanisms/`
- [4] `https://cognitiontoday.com/how-to-be-smarter-50-actionable-tips-to-have-a-sharp-mind-and-increase-intelligence/`
- [5] `https://cognitiontoday.com/how-to-improve-your-memory-and-remembering-capacity/`
...
- [1] `https://cognitiontoday.com/examples-of-everyday-procrastination-mindsets-and-beliefs/`
- [2] `https://cognitiontoday.com/pros-and-cons-of-online-education-and-learning/`
- [3] `https://cognitiontoday.com/phone-addiction-coping-solutions-research-statistics/` ✓
- [4] `https://cognitiontoday.com/psychology-of-memes-advanced-emotions-outsourced-thoughts-mental-health/` ✓
- [5] `https://cognitiontoday.com/productivity-tips-for-early-career-employees/`
...
- [2] `https://cognitiontoday.com/simplifying-depression-a-serious-mental-health-issue/`
- [3] `https://cognitiontoday.com/how-i-broke-out-of-the-cycle-of-depression-guest-post/`
- [4] `https://cognitiontoday.com/how-poor-mental-health-destroys-productivity/`
...
- [1] `https://cognitiontoday.com/consumer-psychology-for-marketers/` ✓
- [2] `https://cognitiontoday.com/14-career-skills-school-students-must-have-before-16/`
- [3] `https://cognitiontoday.com/top-future-proof-job-skills-psychology-students-need/`
